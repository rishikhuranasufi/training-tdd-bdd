...
public class AJUnitBasicsHelloWorldTest extends TestCaseBase {
    ...
    /**
     * PURPOSE OF CLASS - Know basic annotations to be used in JUnit.
     @BeforeClass – Run once before any of the test methods in the class, Important to look at Method Signature - public static void
     @AfterClass – Run once after all the tests in the class have been run, public static void
     @Before – Run before @Test, Important to look at Method Signature -  public void
